...
namespace HZC.MyDapper.Extensions
{
    public static class DapperExtension
    {
        ...
        //    T entity, ConditionBuilder existsSearch, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        ...
        //    IEnumerable<T> entityList, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        ...
        //    List<T> entityList, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        //    var sql = info.GetInsertSql();
        ...
        //    T entity, ConditionBuilder existsUtil, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        ...
        //    T entity, IEnumerable<string> properties, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        ...
        //    T entity, SoKeyValuePairs kvs, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        ...
        //    SoKeyValuePairs kvs, ConditionBuilder search, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        //    var sql = SqlServerBuilder.GetUpdateSetSql(info, kvs);
        //    var param = kvs.ToParameters();
        ...
        //#region 删除
        //public static Task<int> DeleteAsync<T>(this SqlConnection conn, int id, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        ...
        //public static int Delete<T>(this SqlConnection conn, int id, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        //    var sql = info.GetDefaultDeleteSql();
        ...
        //public static Task<int> DeleteAsync<T>(this SqlConnection conn, IEnumerable<int> ids, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        ...
        //public static int Delete<T>(this SqlConnection conn, IEnumerable<int> ids, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        //    var sql = info.IsSoftDelete
        //        ? $"UPDATE [{info.DataTableName}] SET IsDel=1 WHERE Id IN @Ids"
        ...
        //public static Task<int> DeleteBySearchAsync<T>(this SqlConnection conn, ConditionBuilder search) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        ...
        //public static int DeleteBySearch<T>(this SqlConnection conn, ConditionBuilder search) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        //    var sql = info.GetDeleteSql(search);
        //    return conn.Execute(sql, search.ToParameters());
        ...
        //#region 加载实体
        //public static Task<T> LoadAsync<T>(this SqlConnection conn, int id, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        ...
        //public static T Load<T>(this SqlConnection conn, int id, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        //    var sql = $"SELECT {info.GetFullSelectColumns()} FROM [{info.DataTableName}] WHERE Id=@Id";
        //    if (info.IsSoftDelete)
        ...
        //    SortBuilder sort,
        //    SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        //    search = search ?? ConditionBuilder.New();
        //    if (info.IsSoftDelete)
        ...
        //    this SqlConnection conn, ConditionBuilder search, SortBuilder sort, SqlTransaction trans = null) where T : IEntity
        //{
        ...
        //    ConditionBuilder search, SortBuilder sort, int pageIndex, int pageSize, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        //    search = search ?? ConditionBuilder.New();
        //    if (info.IsSoftDelete)
        ...
        //#region 数量
        //public static Task<int> CountAsync<T>(this SqlConnection conn, ConditionBuilder search, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        //    search = search ?? ConditionBuilder.New();
        //    if (info.IsSoftDelete)
        ...
        //public static int Count<T>(this SqlConnection conn, ConditionBuilder search, SqlTransaction trans = null) where T : IEntity
        //{
        //    var info = MyContainer.Get(typeof(T));
        //    search = search ?? ConditionBuilder.New();
        //    if (info.IsSoftDelete)
        ...
        //public static Task<int> CountAsync(this SqlConnection conn, string table, ConditionBuilder search, SqlTransaction trans = null)
        //{
        //    search = search ?? ConditionBuilder.New();
        ...
        //public static int Count(this SqlConnection conn, string table, ConditionBuilder search, SqlTransaction trans = null)
        //{
        //    search = search ?? ConditionBuilder.New();
        //    var sql = $"SELECT COUNT(0) FROM [{table}] WHERE {search.ToCondition()}";
        //    return conn.ExecuteScalar<int>(sql, search.ToParameters(), trans);
